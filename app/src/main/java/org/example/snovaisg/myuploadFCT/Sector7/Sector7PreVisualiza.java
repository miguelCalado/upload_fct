package org.example.snovaisg.myuploadFCT.Sector7;
...
public class Sector7PreVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Sector7PreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void GoToMain(){
        Intent intent = new Intent(Sector7PreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(Sector7PreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
