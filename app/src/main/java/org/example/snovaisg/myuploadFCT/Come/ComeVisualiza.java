...
public class ComeVisualiza extends AppCompatActivity {
    JSONObject Dic;
    JSONObject fullDic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.example.snovaisg.myuploadFCT.R.layout.campuscome);
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ComeVisualiza.this, Atualizado.class);
        ...
        novo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DH.setEditar(false);
                DH.setDenovo(true);
                Intent intent = new Intent(ComeVisualiza.this, UploadPageSopa.class);
                startActivity(intent);
            }
        });
    ...
    public void proceedNormally() throws JSONException {
        ...
        LinearLayout menuLayout = (LinearLayout) findViewById(org.example.snovaisg.myuploadFCT.R.id.menuLayout);
        String[] menus = toStringArray(Dic.getJSONArray("menu"));
        alignPrices.getInstance().alignOne(menus, this, aa, menuLayout);
