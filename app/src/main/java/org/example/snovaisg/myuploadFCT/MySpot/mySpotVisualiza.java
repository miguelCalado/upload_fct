...
public class mySpotVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mySpotVisualiza.this, Atualizado.class);
        ...
        novo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DH.setEditar(false);
                DH.setDenovo(true);
                Intent intent = new Intent(mySpotVisualiza.this, UploadPageSopa.class);
                startActivity(intent);
            }
        });
