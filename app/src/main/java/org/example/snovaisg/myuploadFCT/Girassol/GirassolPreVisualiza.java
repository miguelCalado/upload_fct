package org.example.snovaisg.myuploadFCT.Girassol;
...
public class GirassolPreVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.example.snovaisg.myuploadFCT.R.layout.girassol);
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GirassolPreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void GoToMain(){
        Intent intent = new Intent(GirassolPreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(GirassolPreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
