...
public class TeresaPreVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TeresaPreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void GoToMain(){
        Intent intent = new Intent(TeresaPreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(TeresaPreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
