...
public class BarLidiaPreVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BarLidiaPreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void setUp() {
        ...
        try {
            JsonDic myJson = new JsonDic(fileToInternal, BarLidiaPreVisualiza.this);

            try {
                String bebidas[] = myJson.getStringArray2("Bar D. Lídia", "Bebidas");
    ...
    public void GoToMain(){
        Intent intent = new Intent(BarLidiaPreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(BarLidiaPreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
