...
public class UploadPageOpcao extends AppCompatActivity {
    public static String[] opcao = new String[8];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_page_opcao);
        ids = new int[]{R.id.opcao1,R.id.opcao2,R.id.opcao3,R.id.opcao4,R.id.opcao5,R.id.opcao6,R.id.opcao7,R.id.opcao8};
        ids_preco = new int[]{R.id.precoOpcao1,R.id.precoOpcao2,R.id.precoOpcao3,R.id.precoOpcao4,R.id.precoOpcao5,R.id.precoOpcao6,R.id.precoOpcao7,R.id.precoOpcao8};
        Preencher();
        try {
            Editar();
        ...
        cancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    DH.setDenovo(false);
                    if (getEstado()) {
                        Intent intent = new Intent(UploadPageOpcao.this, Atualizado.class);
                        startActivity(intent);
                    }
                    else {
                        Intent intent = new Intent(UploadPageOpcao.this, PorAtualizar.class);
                        startActivity(intent);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
        ...
        seguinte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                recordString();
                Intent intent = new Intent(UploadPageOpcao.this, UploadPageSobremesa.class);
                startActivity(intent);
            }
    ...
    {
        Intent intent = new Intent(UploadPageOpcao.this, UploadPageDieta.class);
        startActivity(intent);
    }
    ...
    public void Editar() throws JSONException {
        if (DH.getEditar()){
            ...
            String [] vegV1 = toStringArray(menu.getJSONArray("opcao"));
            Log.d("Editar","2");
            int pos = 0;
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if (opcao != null) {
            for (int i = 0; i < opcao.length; i++) {
                if (opcao[i] != null){
                    if (opcao[i].length() >3){
                        savedInstanceState.putString(backupPrato[pos], opcao[i]);
