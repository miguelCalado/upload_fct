...
public class GirassolVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GirassolVisualiza.this, Atualizado.class);
        ...
        novo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DH.setEditar(false);
                DH.setDenovo(true);
                Intent intent = new Intent(GirassolVisualiza.this, UploadPageSopa.class);
                startActivity(intent);
            }
        });
