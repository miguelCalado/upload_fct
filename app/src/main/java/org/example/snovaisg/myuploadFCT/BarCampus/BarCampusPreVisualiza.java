...
public class BarCampusPreVisualiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BarCampusPreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void setUp() {
        ...
        if(sopaV2.length!=0) {
            ...
            TextView sopaTitle = (TextView) findViewById(org.example.snovaisg.myuploadFCT.R.id.sopaTitle);
        ...
        if(sobremesaV2.length!=0) {
            ...
            TextView sobremesaTitle = (TextView) findViewById(org.example.snovaisg.myuploadFCT.R.id.sobremesaTitle);
            sobremesaTitle.setVisibility(View.GONE);
            sobremesaLayout.setVisibility(View.GONE);
        }

        try {
            JsonDic myJson = new JsonDic(fileToInternal, BarCampusPreVisualiza.this);

            try {
                String bebidas[] = myJson.getStringArray2("Bar Campus", "Bebidas");
    ...
    public void GoToMain(){
        Intent intent = new Intent(BarCampusPreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(BarCampusPreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
