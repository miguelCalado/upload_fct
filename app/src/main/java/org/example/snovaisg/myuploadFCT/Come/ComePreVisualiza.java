package org.example.snovaisg.myuploadFCT.Come;
...
import org.example.snovaisg.myuploadFCT.UploadPageMenu;
...
public class ComePreVisualiza extends AppCompatActivity {
    ...
    public static String[] menu = UploadPageMenu.menu;
    public static String[] menuPreco = UploadPageMenu.preco;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ComePreVisualiza.this, UploadPageSobremesa.class);
    ...
    public void run(){
        ...
        for(i=0, pos=0;i<8;i++){
            if (menu[i] != null){
                ...
                if(!menuPreco[i].equals("9999") && menuPreco[i].indexOf('€')==-1) {
                    menuPreco[i]=menuPreco[i]+"€";
                }
            }
        }
        ...
        menuV2 = list.toArray(new String[list.size()]);
    ...
    public void setUp() {
        ...
        if(sopaV2.length!=0) {
            ...
            TextView sopaTitle = (TextView) findViewById(R.id.sopaTitle);
            sopaTitle.setVisibility(View.GONE);
        ...
        lista5 = prepareArray(menuV2, menuPreco);
        String[] menufinal = lista5.toArray(new String[lista5.size()]);
        alignPrices.getInstance().alignOne(menufinal, this, aa, menuLayout);

        LinearLayout sobremesaLayout = (LinearLayout) findViewById(R.id.sobremesaLayout);
        if(sobremesaV2.length!=0) {
    ...
    public void GoToMain(){
        Intent intent = new Intent(ComePreVisualiza.this, Atualizado.class);
        startActivity(intent);
    }
    ...
    public void uploadNormally  (){
        try{
            ...
            Dic.put("menu",new JSONArray(prepareArray(menuV2,menuPreco)));
        ...
        transferObserver.setTransferListener(new TransferListener(){
            ...
            public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                ...
                if (percentage == 100){
                    //DONWLOAD COMPLETED
                    fileUploaded = true;
                    Toast.makeText(ComePreVisualiza.this, "Upload feito com sucesso!", Toast.LENGTH_SHORT).show();
                    GoToMain();
                }
            }
