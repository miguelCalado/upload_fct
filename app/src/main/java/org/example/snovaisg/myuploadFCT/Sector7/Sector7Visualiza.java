...
public class Sector7Visualiza extends AppCompatActivity {
    JSONObject Dic;
    JSONObject fullDic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Sector7Visualiza.this, Atualizado.class);
        ...
        novo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DH.setEditar(false);
                DH.setDenovo(true);
                Intent intent = new Intent(Sector7Visualiza.this, UploadPageSopa.class);
                startActivity(intent);
            }
        });
